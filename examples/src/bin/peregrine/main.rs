...
fn main() {
    ...
    let (mut swapchain, images) = {
        ...
        Swapchain::new(device.clone(), surface.clone(), caps.min_image_count, format, dimensions, 1,
            usage, &queue, SurfaceTransform::Identity, alpha, PresentMode::Fifo, FullscreenExclusive::Default, true, ColorSpace::SrgbNonLinear).unwrap()
    };
        ...
        match event {
            ...
            Event::RedrawEventsCleared => {
                ...
                let uniform_buffer_subbuffer = {
                    ...
                    let view = Matrix4::look_at(Point3::new(0.1, 0.1, 0.3), Point3::new(0.0, 0.0, 0.0), Vector3::new(0.0, -1.0, 0.0));
